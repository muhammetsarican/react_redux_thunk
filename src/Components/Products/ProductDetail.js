...
const ProductDetail = (
    ...
    return (
        <form onSubmit={onSave}>
            ...
            <SelectInput name="categoryId" label={"Category"} value={product.categoryId || ""} defaultOption={"Select an Option"} options={categories.map((category => ({
                value: category.id,
                text: category.categoryName
            })))}
                onChange={onChange}
                error={errors.categoryId}></SelectInput>
